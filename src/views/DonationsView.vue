    ...
    <v-row class="pt-10 justify-center">
      <v-col cols="12" md="6">
        <v-card
          ...
          justify-center
        >
          <div class="text-left mb-6 text-teal text-h6">
            Select Organization
          </div>
...
const items = ref([
  ...
  { title: "Donation", disabled: true, href: "breadcrumbs_link_2" },
]);
const providers = ref([
  { title: "57357", img: require("@/assets/57.png") },
  { title: "Resala", img: require("@/assets/resala.png") },
  { title: "Bet El-Zakat", img: require("@/assets/bet.png") },
  { title: "El Helal El Ahmar El Masry", img: require("@/assets/helal.jpg") },
]);
...
const create_recharge = async () => {
  ...
  const data = {
    ...
    account_id: account,
    organizations: providers.value[selectedCardIndex.value].title,
  };
  apiRequest
    .makePostApiCallHome("/services/donation/", data)
